...
- **Submit Evidence** — report local test results back to OR, linked to the current bundle
...
2. Open **Settings** and configure:
   - `or.apiUrl` — your OR API URL (default: `http://localhost:3001`)
   - `or.apiToken` — your auth token (optional for local dev)
3. Open the command palette (`Cmd+Shift+P`) and run **OR: Fetch Bundle**
